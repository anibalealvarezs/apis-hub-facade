...
<body class="antialiased min-h-screen text-slate-900 dark:text-slate-100 selection:bg-brand-blue selection:text-white" 
    ...
    <div class="theme-toggle" x-cloak>
        <div class="fixed top-8 right-8 flex items-center gap-6 z-50">
            ...
            <button @click="darkMode = !darkMode" class="p-2 rounded-full border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-md glow-hover pointer-events-auto">
    ...
    <!-- Static Footer (End of Flow) -->
    <footer class="py-12 w-full flex flex-col items-center gap-4 px-8 text-[10px] uppercase tracking-[0.3em] font-bold text-slate-400 dark:text-slate-500 select-none border-t border-slate-100 dark:border-white/5">
