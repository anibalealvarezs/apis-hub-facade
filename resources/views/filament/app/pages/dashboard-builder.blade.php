                ...
                <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 rounded-t-xl">
                    <div class="flex flex-col gap-1.5">
                        <div class="flex flex-wrap items-center gap-3">
                            <h3 class="text-base font-bold text-gray-900 dark:text-white" x-text="'{{ __('Configure:') }} ' + (widgetControlsTarget.title || widgetControlsTarget.name)"></h3>
                                        ...
                                        <div class="p-6 flex-1 flex flex-col gap-5 min-h-0">
                                            ...
                                            <div class="gap-3 flex-1 flex flex-col min-h-0 mt-6">
                                                ...
                                                <div class="flex items-center justify-between mt-2">
                                                    <label class="block text-xs font-semibold text-gray-700 dark:text-gray-300">{{ __('Assets') }} <span x-show="widgetKpiConfig.dependent_asset_group">({{ __('Limited to KPI Group') }})</span><span x-show="!widgetKpiConfig.dependent_asset_group">({{ __('Leave empty for All Assets') }})</span></label>
                                                    <div class="flex gap-3">
