<x-filament-panels::page>
    ...
    <div x-data="dashboardBuilder({
        ...
        {{-- Toolbar --}}
        <div class="sticky top-16 z-20 flex items-center justify-between gap-4 rounded-xl bg-gray-50/90 dark:bg-gray-900/90 p-4 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
