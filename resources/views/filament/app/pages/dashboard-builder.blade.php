<x-filament-panels::page>
    ...
    <div x-data="dashboardBuilder({
        ...
        {{-- Toolbar --}}
        <div class="sticky top-0 z-10 flex items-center justify-between gap-4 rounded-xl bg-gray-50/95 dark:bg-gray-900/95 p-4 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 transition-colors">
