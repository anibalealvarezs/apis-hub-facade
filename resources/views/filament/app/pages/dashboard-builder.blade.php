<x-filament-panels::page>
    ...
    <div x-data="dashboardBuilder({
        ...
        <div x-show="selectedWidgetIds.length > 0" x-cloak
             ...
             class="fixed right-6 top-1/2 -translate-y-1/2 z-[99999] flex flex-col items-center gap-1.5 p-2 rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-2xl ring-1 ring-black/5 dark:ring-white/10">
