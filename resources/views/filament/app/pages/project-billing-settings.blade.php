<x-filament-panels::page>
    <div class="space-y-6">
        ...
        @if($billingProfile)
            <!-- Premium Glassmorphic Ficha del Perfil de Facturación -->
            <div class="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition duration-300 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50 dark:backdrop-blur-md">
                    ...
                    <div class="space-y-4 flex-1">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 pt-4 border-t border-gray-100 dark:border-gray-800 text-sm text-gray-600 dark:text-gray-300">
                            <div class="flex items-center gap-2">
                                ...
                                <span>Inicio de Ciclo: <strong class="font-semibold text-gray-900 dark:text-white">{{ $cycleStarts?->format('d M, Y') ?? 'N/A' }}</strong></span>
                            </div>
                            <div class="flex items-center gap-2">
                                <svg class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span>Próxima Renovación: <strong class="font-semibold text-gray-900 dark:text-white">{{ $cycleEnds?->format('d M, Y') ?? 'N/A' }}</strong></span>
                            </div>
                        </div>
                    </div>
        ...
        @else
            ...
            <div class="text-center py-12 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-800 p-6">
                ...
                <h3 class="text-base font-bold text-gray-900 dark:text-white">Sin Perfil de Facturación</h3>
