<x-filament-panels::page>
    ...
    <div x-data="gscDashboard({
        ...
        <div class="gsc-header-row sticky top-16 z-20 py-4 -mt-4 bg-gray-50/90 dark:bg-gray-900/90 backdrop-blur-md border-b border-gray-200 dark:border-white/10">
            <div>
