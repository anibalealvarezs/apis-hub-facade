                            ...
                            @foreach($accounts as $id => $name)
                                <div
                                    ...
                                    <div
                                        ...
                                        <svg x-show="accounts.includes('{{ $id }}')" class="w-3 h-3 text-white"
                                    ...
                                    <div class="flex flex-col overflow-hidden">
                                        <span class="truncate font-medium"
                                              :class="accounts.includes('{{ $id }}') ? 'text-primary-700 dark:text-primary-300' : ''"
                                              title="{{ $name }}">{{ $name }}</span>
                                        {{-- <span class="text-xs truncate"
                                              :class="accounts.includes('{{ $id }}') ? 'text-primary-500 dark:text-primary-400' : 'text-gray-500 dark:text-gray-400'">{{ $id }}</span> --}}
                                    </div>
                                </div>
                            @endforeach
                        </div>
