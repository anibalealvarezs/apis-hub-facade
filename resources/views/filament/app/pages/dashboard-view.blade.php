            ...
            <div x-show="openSettings" style="display: none; z-index: 999999;"
                ...
                <div class="relative bg-white dark:bg-gray-900 rounded-xl shadow-xl mx-auto my-4 sm:my-6 flex flex-col ring-1 ring-gray-900/5 dark:ring-white/10"
                    ...
                    <div class="flex-1 bg-gray-50 dark:bg-gray-900 min-h-0 overflow-y-auto desktop-overflow-hidden relative">
                        <div class="absolute inset-6 md:inset-8 flex flex-col md:flex-row gap-6">
            ...
            window.dashboardView = function() {
                return {
                    ...
                    closeSettings() {
                        ...
                        this.settingsOriginalControls = { date_start: '', date_end: '', granularity: '', metrics: [], series_assets: {} };
