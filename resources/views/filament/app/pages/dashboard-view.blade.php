        ...
        <template x-teleport="body">
            <div x-show="openSettings" style="display: none; z-index: 999999;"
                ...
                <div class="relative bg-white dark:bg-gray-900 rounded-xl shadow-xl mx-auto my-4 sm:my-6 flex flex-col ring-1 ring-gray-900/5 dark:ring-white/10"
                    ...
                    <div class="flex-1 p-6 md:p-8 bg-gray-50 dark:bg-gray-900 flex gap-6 min-h-0 overflow-y-auto md:overflow-hidden" style="flex-wrap: wrap;">
                        
                        {{-- Left Column: Global Configuration --}}
                        <div class="flex flex-col gap-6 overflow-y-auto custom-scrollbar pr-2 pb-2 min-h-0" style="flex: 1 1 250px; max-width: 100%;">
                            {{-- Card: Date Range --}}
                        ...
                        <div class="min-w-0 min-h-0 flex overflow-x-auto gap-6 custom-scrollbar pb-2 items-stretch snap-x snap-mandatory" style="flex: 2 1 500px; max-width: 100%;">
