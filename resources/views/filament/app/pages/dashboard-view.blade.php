        ...
        <template x-teleport="body">
            <div x-show="openSettings" style="display: none; z-index: 999999;"
                ...
                <div class="relative bg-white dark:bg-gray-900 rounded-xl shadow-xl mx-auto my-4 sm:my-6 flex flex-col ring-1 ring-gray-900/5 dark:ring-white/10"
                    ...
                    <div class="flex-1 p-6 md:p-8 bg-gray-50 dark:bg-gray-900 flex flex-col md:flex-row gap-6 min-h-0 overflow-y-auto md:overflow-hidden">
                        
                        {{-- Left Column: Global Configuration --}}
                        <div class="w-full md:w-1/3 flex flex-col gap-6 overflow-y-auto custom-scrollbar pr-2 pb-2 min-h-0 flex-shrink-0">
                            {{-- Card: Date Range --}}
