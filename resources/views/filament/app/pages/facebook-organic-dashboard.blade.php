                ...
                <div class="relative" x-data="{ open: false, searchAccount: '' }" @click.outside="open = false">
                    <button @click="open = !open" type="button"
                        ...
                        <span class="truncate font-medium text-gray-700 dark:text-gray-200"
                              x-text="accounts.length === 0 ? '{{ __('Select Page...') }}' : (accountNames[accounts[0]] || accounts[0])"></span>
                        ...
                        <div class="p-2 flex flex-col gap-1 overflow-y-auto max-h-96">
                            ...
                            @foreach($accounts as $id => $name)
                                <div
                                    ...
                                    @click="accounts = ['{{ $id }}']; open = false; handleAccountChange()"
                                    ...
                                    :class="accounts[0] == '{{ $id }}' ? 'bg-primary-50 dark:bg-primary-900/20 border-primary-200 dark:border-primary-800' : 'hover:bg-gray-100 dark:hover:bg-gray-700 border-transparent'">
                                    <div
                                        class="w-5 h-5 mr-3 shrink-0 flex items-center justify-center rounded-full border-2 transition-colors duration-150"
                                        :class="accounts[0] == '{{ $id }}' ? 'bg-primary-600 border-primary-600' : 'border-gray-300 dark:border-gray-600'">
                                        <svg x-show="accounts[0] == '{{ $id }}'" class="w-3 h-3 text-white"
                                    ...
                                    <div class="flex flex-col overflow-hidden">
                                        <span class="truncate font-medium"
                                              :class="accounts[0] == '{{ $id }}' ? 'text-primary-700 dark:text-primary-300' : ''"
