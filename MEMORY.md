...
### Confirm Modal Component — Cross-Page Style Fix (2026-08-09)
- **Bug:** The widget-removal confirmation modal rendered full-width and pinned to the top of the viewport, inconsistent with the other confirmations (they all use the same `x-confirm-modal` component).
