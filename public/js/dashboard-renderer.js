...
window.dashboardRenderer = {
    ...
    async renderWidget(widgetId, containerEl, controls, tenant) {
        ...
        try {
            const body = { tenant };
            if (controls) {
                const overrideKeys = ['date_start', 'date_end', 'zero_handling', 'granularity', 'metrics', 'assets', 'series_assets', 'series_channels', 'channel', 'edge_case_weighted', 'edge_case_grouping'];
                const overrides = {};
