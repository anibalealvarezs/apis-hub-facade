            ...
            \Filament\Forms\Components\Placeholder::make('filter_' . $fieldKey)
                ...
                ->content(new \Illuminate\Support\HtmlString('
                    <div class="relative w-full max-w-sm mb-4">
                        ...
                        <input type="text" x-model="assetFilter" class="block w-full pl-10 rtl:pr-10 rtl:pl-3 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-primary-500 focus:border-primary-500 sm:text-sm transition duration-150 ease-in-out dark:bg-white/5 dark:border-white/10 dark:text-white" placeholder="Live filter assets by name or ID...">
                    </div>
                ')),
