                                    ...
                                    if ($record->billingProfile?->tier === \App\Enums\UserTier::FREE) {
                                        return new \Illuminate\Support\HtmlString('
                                            <div class="p-3 bg-amber-50 border border-amber-200 rounded-lg text-amber-800 text-sm flex items-center gap-2">
                                                ...
                                                <span><strong>' . __('Free Tier Restriction') . ':</strong> ' . __('AI-assisted classification is currently disabled for Free accounts by default. You can enable it globally in Admin > Features, or the project owner can upgrade their billing tier to Pro.') . '</span>
                                            </div>
                                        ');
                                    }
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('upgradeRelease')
                    ...
                    ->action(function (Project $record, array $data) {
                        ...
                        if ($record->health_status === 'upgrading') {
                            Notification::make()
