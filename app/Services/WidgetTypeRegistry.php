...
class WidgetTypeRegistry
{
    protected static array $compatibility = [
        ...
        'metric' => ['tile', 'line_chart', 'bar_chart', 'pie_chart', 'gauge', 'sparkline', 'combo_chart', 'table'],
        'derived_metric' => ['tile', 'line_chart', 'bar_chart', 'pie_chart', 'gauge', 'sparkline', 'combo_chart', 'table'],
    ];
